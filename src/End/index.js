...
const End = ({ export_trial, bulshit_data, export_calibration, trial_scale_data, risk_game_data, risk_value, formulaire_data, questionnaire_data, distress_data, temporal_data, text, langue }) => {
    ...
    const ques_data = [].concat(ques.q1, ques.q2, ques.q3, ques.q4, ques.q5, ques.r1, ques.r2, ques.r3, ques.r4)
    ...
    const bulshit = bulshit_data.map(function (id) { return id.value }).concat(subject_id, trial_scale_data, ques_data, dis_data, temp_data, risk_game_data, risk_value, form.age, form.genre, form.profession, form.main, form.souris, form.paye, langue)
    ...
    const handleClick = () => {
        ...
        const headers = ['id_trial; stimuli; time; tracking; choice; output; invert; height; width; bulshit_q1; bulshit_q2; bulshit_q3; bulshit_q4; bulshit_q5; bulshit_q6; bulshit_q7; bulshit_q8; bulshit_q9; bulshit_q10; bulshit_q11; bulshit_q12; subject_id; trial_q1; trial_q2; trial_q3; trial_q4; trial_q5; trial_q6; trial_q7; ques_q1; ques_q2; ques_q3; ques_q4; ques_q5; ques_r1; ques_r2; ques_r3; ques_r4; diss_1; diss_2; diss_3; diss_4; diss_5; diss_6; diss_7; diss_8; temporal_1; temporal_2; temporal_3; temporal_4; temporal_5; temporal_6; temporal_7; temporal_8; temporal_9; temporal_10; temporal_11; temporal_12; risk_1; scoreRisk_1; risk_2; scoreRisk_2; risk_3; scoreRisk_3; risk_4; scoreRisk_4; risk_5; scoreRisk_5; risk_6; scoreRisk_6; risk_q; age; genre; profession; main; souris; paye; langue']
